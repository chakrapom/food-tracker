...
const ALL_PRESETS = [
  ...
  // ── Carbs ─────────────────────────────────────────────────
  ['White rice',                    '1 cup cooked',  3.2, 36,   0,   0],
  ['Brown rice',                    '1 cup cooked',  4,   36,   1.6, 3.2],
  ...
  ['Watermelon',                    '2 cups',         0.8, 18.4, 0, 0.8],
  ['Orange',                        '1 medium',       1, 15,  0, 3],

  // ── Vegetables / Fiber ────────────────────────────────────
  ['Mixed greens (luộc)',           '1 cup',  1.6, 3.2, 0, 2.4],
  ['Water spinach (rau muống)',     '1 cup',  2.4, 2.4, 0, 1.6],
  ['Bok choy (cải xanh)',           '1 cup',  0.8, 1.6, 0, 0.8],
  ['Bean sprouts (giá đỗ)',         '1 cup',  2.4, 4.8, 0, 1.6],
  ['Bitter melon (khổ qua)',        '1 cup',  0.8, 3.2, 0, 1.6],
  ['Cabbage (bắp cải)',             '1 cup',  0.8, 4,   0, 1.6],
  ['Broccoli',                      '1 cup',  2.4, 4.8, 0, 1.6],
  ['Tomato',                        '1 medium', 1, 4, 0, 1],
  ['Eggplant (cà tím)',             '1 cup',  0.8, 6.4, 0, 1.6],
  ['Mushroom',                      '1 cup',  2.4, 3.2, 0, 1.6],
  ['Cucumber',                      '1 cup',  0.8, 2.4, 0, 0.8],
  ['Canh chua (sour soup)',         '1 cup', 5,  6,  1, 3],
  ['Canh khoai mỡ (yam soup)',      '1 cup', 4,  8,  1, 4],
  ['Canh rau (vegetable soup)',     '1 cup', 2,  4,  0, 2],
